...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# define the inverse of the logit link function}
\CommentTok{# the exp function is the inverse of the log link}
\NormalTok{inv_logit <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{exp}\NormalTok{(x) }\OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\KeywordTok{exp}\NormalTok{(x))}
